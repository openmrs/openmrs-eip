...
public class FetchModelsByLastSyncDateRuleTest {
	...
	public void evaluate_should_return_true() {
		// Given
		ProducerParams params = ProducerParams.builder().lastSyncDate(LAST_SYNC_DATE).build();
	...
	public void getModels_should_call_facade() {
		// Given
		ProducerParams params = ProducerParams.builder().tableToSync(TableToSyncEnum.PERSON).lastSyncDate(LAST_SYNC_DATE)
		        .build();
