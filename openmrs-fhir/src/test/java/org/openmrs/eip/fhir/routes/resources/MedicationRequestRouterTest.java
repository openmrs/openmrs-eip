...
class MedicationRequestRouterTest extends CamelSpringTestSupport {
	...
	void shouldHandleDrugOrderEntry() throws InterruptedException {
		...
		template.send((exchange) -> {
			exchange.setProperty(PROP_EVENT_TABLE_NAME, "drug_order");
		...
		MedicationRequest medicationRequest = FhirContext.forR4().newJsonParser().parseResource(MedicationRequest.class,
