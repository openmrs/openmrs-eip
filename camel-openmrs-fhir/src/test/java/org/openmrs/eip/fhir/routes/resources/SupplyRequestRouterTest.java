...
@UseAdviceWith
@Disabled //TODO: {{openmrs.baseUrl}} is not being picked from application-test.properties
class SupplyRequestRouterTest extends CamelSpringTestSupport {
	...
	protected RoutesBuilder createRouteBuilder() {
		RouteBuilder rb = new SupplyRequestRouter();
		rb.from(FhirResource.SUPPLYREQUEST.outgoingUrl()).to("mock:result");
		return rb;
	}
